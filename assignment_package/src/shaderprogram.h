...
public:
    ...
    int attrUV; // A handle for the "in" vec4 represent vertex uv in the vertex shader
...
public:
    ...
    void createSnow(const char *vertfile, const char *fragfile);
    ...
    //Draw given interleaved data
    void drawInterleaved(Drawable &d);

    // Draw transparnet and opaque
    ...
    void drawInstanced(SimpleInstancedDrawable &d);
    ...
    // set time t which is used for shader
    void setTime(int t);
