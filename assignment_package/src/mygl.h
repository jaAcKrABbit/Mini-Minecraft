...
private:
    ...
    qint64 previousFrame;
    qint64 currentFrame;
    QPoint global = mapToGlobal(QPoint(width() / 2.f, height() / 2.f));

    std::vector<std::shared_ptr<Texture>> shared_texture;
    Texture* m_texture;
